<template>
  <div v-if="isVisible">
    <h3>Modifier les données du membre:</h3>
    <form class="row gx-3 gy-2 align-items-center" @submit.prevent="onSubmit">
      ...
      <div class="col-sm-2">
        ...
        <input type="date" class="form-control" id="date" v-model="dateInscription" />
      </div>
      <div class="col-sm-2">
        <label for="tel">Téléphone</label>
        <input type="tel" class="form-control" id="tel" v-model="telephone" />
      </div>
      <div class="col-auto">
